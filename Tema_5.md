...
## Выводы
Множественное присваивание можно использовать для массивов
...
## Выводы
Список можно сортировать с помощью sort() и удалять элементы с помощью pop()
...
## Выводы
С помощью генераторов списков можно создавать многомерные структуры
...
## Выводы
Генераторы списков позволяют создавать многомерные структуры
...
## Выводы
Срез с шагом -1 позволяет развернуть список в одну строку
